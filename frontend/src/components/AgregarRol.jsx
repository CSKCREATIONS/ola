      ...
      <>
         {isVisible && (
            <div
               ...
               onClick={(e) => { if (e.target.id === 'add-role-modal') closeModal(); }}
            >
               <dialog
                  aria-modal="true"
               ...
               >
                  <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
                     <div style={{
                        ...
                        <h3 id="add-role-title" style={{ margin: 0, fontSize: '1.5rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                              ...
                              <div style={{ display: 'flex', gap: 24, marginTop: 12, flexWrap: 'wrap' }}>
                                 ...
                                 {mostrarListaUsuarios && (
                                    <div id="lista-usuarios" style={{
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#1e40af', fontSize: '0.95rem' }}>Permisos para lista de usuarios</h5>
                                 ...
                                 {mostrarListaRoles && (
                                    <div id="roles-y-permisos" style={{
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#1e40af', fontSize: '0.95rem' }}>Permisos para roles y permisos</h5>
                           ...
                           <div style={{
                              ...
                              <div style={{ display: 'flex', gap: 24, marginTop: 12, flexWrap: 'wrap' }}>
                                 ...
                                 {mostrarOrdenesCompra && (
                                    <div id="ordenes-de-compra" style={{
                                       minWidth: 260,
                                       backgroundColor: 'white',
                                       padding: '1.25rem',
                                       borderRadius: '10px',
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#065f46', fontSize: '0.95rem' }}>Permisos para Órdenes de compra</h5>
                                 ...
                                 {mostrarHistorialCompras && (
                                    <div id="historial-de-compras" style={{
                                       minWidth: 260,
                                       backgroundColor: 'white',
                                       padding: '1.25rem',
                                       borderRadius: '10px',
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#065f46', fontSize: '0.95rem' }}>Permisos para Historial de compras</h5>
                                 ...
                                 {mostrarProveedores && (
                                    <div id="proveedores" style={{
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#065f46', fontSize: '0.95rem' }}>Permisos para Proveedores</h5>
                              ...
                              <div style={{ display: 'flex', gap: 24, marginTop: 12, flexWrap: 'wrap' }}>
                                 ...
                                 {mostrarCategorias && (
                                    <div id="categorias" style={{
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#92400e', fontSize: '0.95rem' }}>Permisos para Categorias</h5>
                                 ...
                                 {mostrarInventario && (
                                    <div id="lista-productos" style={{
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#92400e', fontSize: '0.95rem' }}>Permisos para Control de Inventario</h5>
                        ...
                        {mostrarVentas && (
                           <div style={{
                              ...
                              <div style={{ display: 'flex', gap: 24, marginTop: 12, flexWrap: 'wrap' }}>
                                 ...
                                 {mostrarCotizaciones && (
                                    <div id="lista-de-cotizaciones" style={{
                                       minWidth: 260,
                                       backgroundColor: 'white',
                                       padding: '1.25rem',
                                       borderRadius: '10px',
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#9f1239', fontSize: '0.95rem' }}>Permisos para Lista de cotizaciones</h5>
                                 ...
                                 {mostrarPedidos && (
                                    <div id="pedidos" style={{
                                       ...
                                       <h5 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#9f1239', fontSize: '0.95rem' }}>Permisos para Pedidos</h5>
                                 ...
                                 {mostrarPedidosAgendados && (
                                    <div id="lista-productos" style={{
                                       ...
                                       <h6 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#9f1239', fontSize: '0.95rem' }}>Permisos para Pedidos agendados</h6>
                                 ...
                                 {mostrarRemisiones && (
                                    <div id="remisiones" style={{
                                       ...
                                       <h6 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#9f1239', fontSize: '0.95rem' }}>Permisos para pedidos entregados</h6>
                                 ...
                                 {mostrarClientes && (
                                    <div id="lista-productos" style={{
                                       ...
                                       <h6 style={{ margin: '0 0 .5rem 0', fontWeight: 600, color: '#9f1239', fontSize: '0.95rem' }}>Permisos para Clientes</h6>
